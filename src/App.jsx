...
function MobileNav() {
  ...
  return (
    <nav style={{ display: 'none', position: 'fixed', bottom: 0, left: 0, right: 0, background: '#fff', borderTop: '0.5px solid var(--border)', zIndex: 50, padding: '4px 0 env(safe-area-inset-bottom)' }} className="mobile-nav">
